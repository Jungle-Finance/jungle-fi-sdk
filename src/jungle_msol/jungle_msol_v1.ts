    ...
    instructions: [
        {
            ...
            accounts: [
                ...
                },
                {
                    ...
                    isMut: true;
                    isSigner: false;
                    docs: ["Stores SOL, accumulated and unstaked vault rewards redeemed from here"];
                },
                {
                    name: "jRedeemPool";
                    isMut: false;
                    isSigner: false;
                    docs: ["Stores SOL, unstaked vault assets redeemed from here"];
                },
                {
                    name: "solHoldingPool";
                    isMut: true;
                ...
                },
                {
                    ...
                    isMut: true;
                    isSigner: true;
                    docs: ["Staked mSOL stored here during active phase"];
                },
                {
                    name: "solFeeWallet";
                    isMut: false;
                    isSigner: false;
                    docs: ["Warmup and redeem pool fees"];
                },
                {
                    name: "msolFeeWallet";
                    isMut: false;
                    isSigner: false;
                    docs: ["Active phase fees, mSOL"];
                },
                {
                    name: "msolState";
                    isMut: false;
                    isSigner: false;
                    docs: ["Marinade account used for CPI"];
                },
                {
                    name: "clock";
                    isMut: false;
            ...
            accounts: [
                {
                    ...
                    isMut: true;
                    isSigner: true;
                    docs: ["Signing, fee-paying, unpermissioned executor of this operation."];
                },
                {
                    name: "vaultInfo";
                    isMut: true;
                    isSigner: false;
                    docs: ["The vault whose lifecycle will be advanced into the active phase."];
                },
                {
                    name: "msolMint";
                    isMut: true;
                    isSigner: false;
                    docs: ["Marinade account for CPI"];
                },
                {
                    name: "solHoldingPool";
                    isMut: true;
                    isSigner: false;
                    docs: ["SOL holdings prior to active phase"];
                },
                {
                    name: "msolHoldingPool";
                    isMut: true;
                    isSigner: false;
                    docs: ["mSOL holdings during active phase"];
                },
                {
                    name: "msolState";
                    isMut: true;
        ...
        },
        {
            ...
            accounts: [
                ...
                },
                {
                    ...
                    isMut: true;
                    isSigner: false;
                    docs: ["The vault to crank into Unstaking phase"];
                },
                {
                    name: "msolMint";
                    isMut: true;
                ...
                },
                {
                    ...
                    isMut: true;
                    isSigner: false;
                    docs: ["PDA that stores mSOL state"];
                },
                {
                    name: "tokenProgram";
                    isMut: false;
        ...
        },
        {
            ...
            accounts: [
                ...
                },
                {
                    ...
                    isMut: true;
                    isSigner: false;
                    docs: ["The vault whose lifecycle will be advanced into the expired phase."];
                },
                {
                    name: "iRedeemPool";
                    isMut: true;
                    isSigner: false;
                    docs: ["Destination of the vault staking rewards."];
                },
                {
                    name: "jRedeemPool";
                    isMut: true;
                    isSigner: false;
                    docs: ["Destination of the vault staked assets."];
                },
                {
                    name: "solHoldingPool";
                    isMut: true;
        ...
        },
        {
            ...
            type: {
                ...
                fields: [
                    ...
                    {
                        name: "msolMint";
                        docs: ["Msol mint TODO: this can be hardcoded and removed from pda"];
                        type: "publicKey";
                    },
                    {
                        name: "jAuthority";
                    ...
                    {
                        name: "claimTicket";
                        docs: ["Order Unstake claim ticket"];
                        type: {
                            option: "publicKey";
                        };
                    }
